		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "The Film Catalogue",
									"targetURL": "#filmcatalogue-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"filmcatalogue-display": {
								"semanticObject": "filmcatalogue",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=filmcatalogue",
									"url": sap.ui.require.toUrl("filmcatalogue")
								}
							}
						}
					}
